            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <p className="text-foreground/80">
                  EqualRise was created as part of the CFCHackathon. Our platform serves as a bridge between technology and social impact, offering innovative solutions for promoting equality and inclusion.
                </p>
                <p className="text-foreground/80">
